...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~7EFxlabS#Joo7FaMfb09RQTLq6ymqtgMEIjGh8P1GZ3LV0DJyqyU",
    ...
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "D@gma",           // Owner's name
    ...
    STICKER_NAME: process.env.STICKER_NAME || "D@GMA",     // Sticker pack name
